...
public class SeizeAdvantage extends AbstractDynamicCard {
     ...
     * Read up on the instructions at the bottom. Basically replace anywhere you'd put your cards name with SeizeAdvantage
    ...
    public static final String ID = DefaultMod.makeID(SeizeAdvantage.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
    public static final String IMG = makeCardPath("Attack.png");// "public static final String IMG = makeCardPath("SeizeAdvantage.png");
