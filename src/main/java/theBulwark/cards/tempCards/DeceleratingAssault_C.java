...
public class DeceleratingAssault_C extends AbstractDynamicCard {
    ...
    public static final String ID = DefaultMod.makeID(DeceleratingAssault_C.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        AbstractCard temp = new DeceleratingAssault_C();
        if( upgraded )
            temp.upgrade();
        AbstractDungeon.actionManager.addToBottom(
                new MakeTempCardInHandAction( temp, 1 )
        );
    }
